...
`rm -rf assets/bin && mkdir -p assets/bin && touch assets/bin/.gitkeep`
`test -f libs/armeabi/s_ffmpeg && cp -f libs/armeabi/s_ffmpeg assets/bin/ffmpeg`
`test -f libs/armeabi-v7a/s_ffmpeg && cp -f libs/armeabi-v7a/s_ffmpeg assets/bin/ffmpeg`
